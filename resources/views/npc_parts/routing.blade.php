        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-slate-50 dark:bg-gray-800/50 p-4 rounded-lg border border-slate-200 dark:border-gray-700 mb-6">
                <div>
                    ...
                    <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ optional(optional($part->event)->masterEvent)->name ?? optional(optional($part->event)->customerCategory)->name ?? '-' }}</span>
                </div>
                <div>
