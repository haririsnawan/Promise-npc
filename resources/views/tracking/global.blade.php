                        ...
                        <tr @click="activeModal = {{ $po->id }}" class="cursor-pointer bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition group text-sm">
                            <td class="px-6 py-4">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <div class="text-blue-600 dark:text-blue-400 font-bold text-[11px] uppercase tracking-wide bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 px-2 py-0.5 inline-block rounded mb-1">{{ optional(optional($po->event)->masterEvent)->name ?? optional(optional($po->event)->customerCategory)->name ?? 'Unknown Event' }}</div>
